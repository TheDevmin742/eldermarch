...
window.ELDERMARCH.appendix = {
  ...
  items: [
    ...
    {
      name: "The Shovel", rarity: "common", magic: false,
      kind: "Weapon (allegedly a tool)", holder: "Lloyd",
      desc: "Traded for in Mirewatch by a paladin of impeccable breeding, and wielded like a warhammer with a pedigree. Hits like a quarterstaff, digs like a dream, and has already seen more honest work than most swords.",
    },
    {
      name: "Longsword & javelins", rarity: "common", magic: false,
      kind: "Weapons", holder: "Lloyd",
      desc: "The respectable half of the arsenal — a two-handed longsword for when dignity is required, javelins for when the enemy is rude enough to stand at range.",
    },
    {
      name: "Holy water", rarity: "common", magic: false,
      kind: "Consumable", holder: "Lloyd",
      desc: "Thrown: 2d8 radiant against fiends and undead. Blessed, bottled, and billed to the church at a very reasonable rate.",
    },
    {
  ...
  spells: [
    ...
    { name: "Cure Wounds", level: "1st", school: "Evocation", meta: "Action · touch", casters: ["Thalasstheos", "Lloyd"],
      desc: "Healing energy through the hands: restore 1d8+3 hit points (Lloyd heals 1d8+4). No effect on undead or constructs — some things don't want mending." },
    { name: "Bless", level: "1st", school: "Enchantment", meta: "Action · 30 ft · Concentration", casters: ["Lloyd"],
      desc: "Up to three creatures add 1d4 to every attack roll and saving throw while it holds. The best opener a front line ever had." },
    { name: "Shield of Faith", level: "1st", school: "Abjuration", meta: "Bonus action · 60 ft · Concentration", casters: ["Lloyd"],
      desc: "A shimmering field grants +2 AC to one creature. Cast on himself, the wall becomes AC 20 and extremely smug about it." },
    { name: "Command", level: "1st", school: "Enchantment", meta: "Action · 60 ft", casters: ["Lloyd"],
      desc: "One word — Approach, Drop, Flee, Grovel, Halt — and the target obeys on a failed wisdom save. Delivered, naturally, in an aristocrat's tone." },
    ...
    /* ---- 2nd level ---- */
    { name: "Aid", level: "2nd", school: "Abjuration", meta: "Action · 30 ft", casters: ["Lloyd"],
      desc: "Three allies gain +5 maximum and current hit points for eight hours. Quiet, unglamorous, and has won more fights than any fireball." },
    { name: "Zone of Truth", level: "2nd", school: "Enchantment", meta: "Action · 60 ft", casters: ["Lloyd"],
      desc: "A 15-foot zone in which deliberate lies cannot be spoken. Sworn to the god of honest coin — of course he brought this one." },
